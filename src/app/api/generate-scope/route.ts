...
export async function POST(request: Request) {
  try {
    ...
    // Process parameters directly out of unified structural JSON payloads cleanly
    ...
    // Structural contextual parsing data mapped directly from your project document manifest
    ...
    const systemInstruction = `
      ...
      ${fileContext ? fileContext : hardcodedIkeaPackageFallback}
